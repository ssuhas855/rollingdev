...
Ajaxinate.prototype.addScrollListeners =
  function addEventListenersForScrolling() {
    if (this.paginationElement) {
      ...
      // document.addEventListener("click", this.checkIfPaginationInView);
...
Ajaxinate.prototype.updateCount = function updateRecipesCount() {
  var recipeCount = $("#AjaxinateLoop").find(".blog-articles__article").length;
  if (recipeCount > 0) {
    $(".filters-toolbar__product-count").html(recipeCount + " products");
    $("#empty_collection").addClass("hide");
  } else if (recipeCount > 1) {
    $(".filters-toolbar__product-count").html(recipeCount + " product");
